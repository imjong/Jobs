					...
					<form role="form" name="frm" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-md-8">
								...
								<div class="form-group">
									<label for="type">공개채용과 특별채용중 선택하시기 바랍니다.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label> 
								...
								<div class="form-group">
									<label for="career">신입직원과 경력직원중 선택하시기
										바랍니다.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label> 
										<input type="radio" name="career" value="1" id="career">신입
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
									<input type="radio" name="career" value="2" id="career">경력
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
									<input type="radio" name="career" value="3" id="career">해당없음
								</div>
							</div>
							<div class="col-md-4">
								<div>
						...
						<div class="form-group">
							<label for="recruitfile">파일 첨부</label> <input class="form-control-file border" type="file" id="recruitfile" name="recruitfile">
						</div>
						<div class="form-group">
