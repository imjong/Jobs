			...
			<div class="row">
				...
				<div align="center" class="col-md-6 col-md-offset-3">
					<table class="table table-responsive">
						<thead>
							<tr>
								<th colspan="2" class="text-center"><a href="cojoin">기업회원
										가입은 이곳을 클릭하세요</a></th>
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								<td class=" text-right" width="30%">
									<label for="imagefile" class="control-label">본인사진 등록</label>
								</td>
								<td width="70%">
							...
							<tr>
								<td class="text-center">
									<input class="form-control"
										id="state" name="state" value="0" readonly type="hidden">
								</td>
								<td class="text-right">
